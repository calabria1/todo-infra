...
resource "aws_apigatewayv2_integration" "lambda" {
  ...
  integration_uri = "arn:aws:apigateway:${var.aws_region}:lambda:path/2015-03-31/functions/${aws_lambda_function.tarefas.arn}/invocations"  payload_format_version = "2.0"
}
